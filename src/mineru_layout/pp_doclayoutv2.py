...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="PP-DocLayoutV2 standalone smoke test")
    parser.add_argument("image", help="Path to an input image (rendered PDF page)")
    parser.add_argument("--model", required=True, help="Path to the PP-DocLayoutV2 weights directory")
